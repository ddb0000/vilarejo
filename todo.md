...
2. [ ] Surface per-agent memory retrieval (top 3 RRI hits) inside the sidebar for quick inspection.
...
9. [ ] Create a minimal inspector overlay that shows the planner RRI breakdown for the highlighted agent.
